...
# dd if=/dev/zero of=/home/user/spi.bin bs=1M count=16
dd if=$UBOOT_FILE of=/home/user/spi.bin bs=1K conv=notrunc
dd if=$DTB_FILE of=/home/user/spi.bin bs=1K seek=1024 conv=notrunc
dd if=$KERNEL_FILE of=/home/user/spi.bin bs=1K seek=1088 conv=notrunc
